 ...
 * 	Modified by Justin Fuhrmeister-Clarke <justin@fuhrmeister-clarke.com> for use with pi-top-battery
 *
...
#define ACPI_PATH_SYS_POWER_SUPPY   "/opt/pi-top-battery-sys"
